...
class UserRigstViewController: RegistViewController, UIWebViewDelegate/*, UITableViewDelegate, UITableViewDataSource*/ {
...
//    
    override func viewDidLoad() {
        ...
        var url = ""
        if self.pageIndex == 0 {
            url = "https://www.usacl.com/app/v1/index.php?route=team/app_tree&arrow=left&token=" + (UserDefaults.standard.object(forKey: "token") as? String)!
        }else{
            url = "https://www.usacl.com/app/v1/index.php?route=team/app_tree&arrow=right&token=" + (UserDefaults.standard.object(forKey: "token") as? String)!
        }
